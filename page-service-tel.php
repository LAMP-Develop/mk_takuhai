...
<p>ドライバーが商品をお預かりする際に、宅配料（現金）をドライバーにお支払いください。宅配料の領収書が必要な場合はドライバーにお申し付けください。料理代金は直接お客様と精算願います。</p>
<p class="small mt-2">※ 商品代の収受に関して、MKは一切関与いたしません。<br>【事前決済の場合】自社サイトや宅配サイトなど、オンライン決済が可能な飲食店様はそちらをご利用ください。<br>【事後決済の場合】事後決済はQRコード決済のみ可能です。<br>飲食店様が契約されているQRコード決済のシールやQRコードが記された用紙をご用意いただければ、お届け時にお客様が送金操作をするところまでドライバーは確認いたします（決済完了、不能、金額差額などについては一切の責任を負いません。<br>また、QRコードが記された用紙をお店に返却することはできませんのでコピーなどのご用意をお願いいたします）。</p>
</div>
</div>
<div class="lp__feature__list__inner">
<div class="lp__feature__list__inner-wrap">
...
<p>MKタクシーが店舗様へ商品を受け取りに向かいます。お預かりした商品を、専用BOX（40cm×24cm）にてお客様のもとへ大切にお届けいたします。京都のみ時間指定（MKが店舗で商品を受け取る時刻）が可能です。</p>
<p class="small mt-2">※ 容器や梱包は店舗様でお願いいたします。</p>
</div>
</div>
<div class="lp__feature__list__inner">
<div class="lp__feature__list__inner-wrap">
...
<p class="small mt-2">
  ※ お店の近くに到着しましたらお電話いたします。ウイルス感染予防のため、トランクへの積み込みはお店の方に行っていただきます（ドライバーは商品に触れません）。
  <br>※ 宅配先においても、お客様に直接トランクからお受け取りいただけます。
  <br>※ 保冷バッグはご用意しておりますが、保冷剤などは各店舗でご用意をお願いいたします。
